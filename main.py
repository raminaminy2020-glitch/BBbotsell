...
# =================== تنظیمات ===================
BOT_TOKEN      = "8820664006:AAE47hM6_HFwI8mpM7OXge4osCwmSzyhFm0"
ADMIN_ID       = 8267296763
...
def cmd_start(message):
    ...
    welcome = (
        ...
        "🌐 <b> اتصال پایدار | سرعت بالا</b>/n"
        "🔥 <b>پلن‌های فیلترشکن با قیمت باورنکردنی!</b>/n"
        "✔️ <b> کاربر : نامحدود | ✔️ مدت : یك ماهه<b>/n"
        "از منوي زیر شروع کن : 👇"
    )
